...
Welcome to the **AutoDS** wiki — the end-to-end data science pipeline platform.
Upload data, and AutoDS ingests, cleans, explores, and (soon) trains and compares
models automatically.

## Navigation

- **[Getting Started](Getting-Started.md)** — install and run in 5 minutes.
- **[Concepts & Glossary](Glossary.md)** — datasets, runs, tasks, stages explained.
...
3. **Clean** the data — dedup, impute missing values, coerce dates, handle outliers.
